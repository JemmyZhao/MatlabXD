###########################################################################
## Makefile generated for Simulink model 'PID1'. 
## 
## Makefile     : PID1.mk
## Generated on : Mon Jun 26 11:06:35 2017
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PID1.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = PID1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = PID1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PID1.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/PID1_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=PID1 -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO
...
SRCS = $(START_DIR)/PID1_ert_rtw/PID1.cpp

MAIN_SRC = $(START_DIR)/PID1_ert_rtw/ert_main.cpp
...
%.obj : $(START_DIR)/PID1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PID1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
