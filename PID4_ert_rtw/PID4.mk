###########################################################################
## Makefile generated for Simulink model 'PID4'. 
## 
## Makefile     : PID4.mk
## Generated on : Fri Jun 23 11:33:45 2017
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PID4.exe
...
MATLAB_ARCH_BIN           = D:/Program Files/Matlab/bin/win64
MASTER_ANCHOR_DIR         = 
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = PID4_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = PID4_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PID4.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/PID4_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=PID4 -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO
...
SRCS = $(START_DIR)/PID4_ert_rtw/PID4.cpp

MAIN_SRC = $(START_DIR)/PID4_ert_rtw/ert_main.cpp
...
%.obj : $(START_DIR)/PID4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PID4_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
