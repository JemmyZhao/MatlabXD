...
// File: PID3.cpp
//
// Code generated for Simulink model 'PID3'.
//
// Model version                  : 1.10
// Simulink Coder version         : 8.9 (R2015b) 13-Aug-2015
// C/C++ source code generated on : Mon Jun 26 11:24:31 2017
//
...
extern void PID3_derivatives();

//
// This function updates continuous states using the ODE2 fixed-step
// solver algorithm
//
void PID3ModelClass::rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
...
// Model step function
void PID3ModelClass::step()
{
  real_T rtb_Sum_c;
  real_T rtb_Sum9;
  real_T rtb_ProportionalGain_fx;
  ...
  rtb_Sum9 = (rtX.Integrator_CSTATE + rtDW.FilterCoefficient) - rtU.yaw_vel_fb;
  ...
  rtDW.FilterCoefficient_a = (100.0 * rtb_Sum9 - rtX.Filter_CSTATE_o) * 20.0;
  ...
  rtb_Sum_c = (rtX.Integrator_CSTATE_l1 + rtDW.FilterCoefficient_m) -
    rtU.roll_vel_fb;
  ...
  rtb_ProportionalGain_fx = 1000.0 * rtb_Sum_c;
  ...
  rtb_Sum_c = (rtX.Integrator_CSTATE_a + rtDW.FilterCoefficient_e) -
    rtU.pitch_vel_fb;
  ...
  rtb_Sum9 = (1500.0 * rtb_Sum9 + rtX.Integrator_CSTATE_l) +
  ...
  if (rtb_Sum9 > 1000.0) {
    ...
    rtY.yaw_out = 1000.0;
  } else if (rtb_Sum9 < -1000.0) {
    // Outport: '<Root>/yaw_out'
    rtY.yaw_out = -1000.0;
  } else {
    // Outport: '<Root>/yaw_out'
    rtY.yaw_out = rtb_Sum9;
  }
  ...
  rtb_Sum9 = (rtb_ProportionalGain_fx + rtX.Integrator_CSTATE_i) +
  ...
  rtb_Sum9 = (1000.0 * rtb_Sum_c + rtX.Integrator_CSTATE_id) +
...
void PID3ModelClass::PID3_derivatives()
{
  XDot *_rtXdot;
...
void PID3ModelClass::initialize()
{
  // Registration code
  {
    // Setup solver object
...
RT_MODEL * PID3ModelClass::getRTM()
{
  return (&rtM);
}
